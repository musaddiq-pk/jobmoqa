...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-9988342009919358",
  ...
  <header>
     <div class="container">
      <div class="row">
        ...
        <div class="col-md-7 top-add pull-right">
          ...
          <div class="row">
              ...
              <div id="mySidenav" class="sidenav">
                ...
                <ul class="menu hidden-xs">
                  ...
                  <li><a href="<?=BASE_URL?>industries">Jobs By Industries</a></li>
                  <li><a href="<?=BASE_URL?>regions">Jobs By Region</a></li>
